...
class AuthManager {
    ...
    async handleTokenLogin(token) {
        ...
        try {
            ...
            // Normalize fields (Frontend-side normalization)
            if (!userData.compName && userData.Company_name) userData.compName = userData.Company_name;
            if (!userData.companyLogo && userData.comp_logo) userData.companyLogo = userData.comp_logo;
            if (!userData.branchFullName && userData.branch_full_name) userData.branchFullName = userData.branch_full_name;
